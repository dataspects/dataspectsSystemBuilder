#!/bin/bash
#[[IsDataspectsSystemBuildConfiguration::Minimal UI Production]]
CONTROL_FOLDER_PATH=/home/lex/dssminimaluiproduction # Must be absolute!
PLATFORM=linux # linux|mac|windows
DOCKER_VOLUMES_MODE=automatic # automatic|manual
DOCKER_COMPOSE_FILE=docker-compose-minimal-ui-PRODUCTION
source secrets.sh
